            ...
            if futures:
                ...
                for future in done:
                    ...
                    if record["status"] != "failed":
                        results[nid] = result
            elif outstanding and len(outstanding) < before_skip:
                continue  # propagate failure through reverse-ordered descendants
            elif outstanding:
